...
description: Build a Vue 3 audit-log table page with multi-field filter bar (event type / user / date range / severity), live indicator, monospace timestamps, severity-tinted rows, and large pagination.
---

...
description: Build a 3-step Vue 3 wizard (template picker → form → review/submit) matching the NewRequestPage pattern with stepper UI, per-step validation, and i18n keys.
---

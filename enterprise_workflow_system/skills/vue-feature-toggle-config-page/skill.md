...
description: Build a Vue 3 admin page that lists feature toggles or remote config keys as cards with category badges, on/off switches, beta tags, and metadata footer.
---

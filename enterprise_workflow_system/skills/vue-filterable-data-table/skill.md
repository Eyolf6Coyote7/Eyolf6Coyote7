...
description: Build a Vue 3 filterable list page with stat chips, multi-select filter bar, search input, paginated table, and row click navigation — matching UserManagementPage/RequestListPage.
---

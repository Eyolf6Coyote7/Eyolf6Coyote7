...
description: Build a Vue 3 KPI dashboard page with 4-column metric cards plus 4 echarts panels (bar, line area, doughnut pie, custom bar list) using vue-echarts and tree-shaken echarts core.
---

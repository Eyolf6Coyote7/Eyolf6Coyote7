...
description: Add a typed API method to a Vue 3 project that switches between mock-client and real-client (axios) at module load time via VITE_MOCK, with shared TypeScript types.
when_to_use:

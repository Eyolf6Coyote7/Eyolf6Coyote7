...
description: Wire Pinia auth store + Vue Router beforeEach guard + isMock auto-login + localStorage token persistence, matching the admin-dashboard/employee-portal pattern.
when_to_use:

...
- [Development Phases](#development-phases)
  - [Initial Development (v0 → v1)](#initial-development-v0-v1)
...
- [User Journey Map](#user-journey-map)
  - [[Persona Name] Journey](#persona-name-journey)
- [Feature List](#feature-list)
- [Feature Details](#feature-details)
  - [F1: [Feature Name]](#f1-feature-name)
- [Non-functional Requirements](#non-functional-requirements)
- [Release Criteria](#release-criteria)
- [Dependencies](#dependencies)
- [Design Principles](#design-principles)
- [Figma Project Structure](#figma-project-structure)
  - [Figma File Organization](#figma-file-organization)
  - [Figma Pages (within each file)](#figma-pages-within-each-file)
- [Design Tools](#design-tools)
- [Figma Workflow](#figma-workflow)
- [Figma + Stitch Version Control](#figma-stitch-version-control)
  - [Figma Side — How to Operate](#figma-side-how-to-operate)
  - [Repo Side — How to Sync with Git](#repo-side-how-to-sync-with-git)
...
- [Mobile UI (iOS + Android)](#mobile-ui-ios-android)
  ...
  - [Platform-specific Screens](#platform-specific-screens)
- [Admin UI (if applicable)](#admin-ui-if-applicable)
  - [Screen Inventory (Admin)](#screen-inventory-admin)
  - [Admin-specific Patterns](#admin-specific-patterns)
- [Screen States (every screen on every platform must define all states)](#screen-states-every-screen-on-every-platform-must-define-all-states)
...
- [C4 Model](#c4-model)
  ...
  - [Level 3: Component Diagram (per system)](#level-3-component-diagram-per-system)
- [Component Overview](#component-overview)
- [Data Flow (Sequence Diagrams)](#data-flow-sequence-diagrams)
  - [Flow 1: [Scenario Name]](#flow-1-scenario-name)
  - [Flow 2: [Async Scenario]](#flow-2-async-scenario)
...
- [ADRs Created](#adrs-created)
- [System: [System Name, e.g. "BFF + API (NestJS)"]](#system-system-name-eg-bff-api-nestjs)
  - [API Specification](#api-specification)
  - [WebSocket / SignalR / gRPC Events](#websocket-signalr-grpc-events)
  - [Database Tables (owned by this system)](#database-tables-owned-by-this-system)
  - [Indexes](#indexes)
- [System: [Next System, e.g. "AI Service (LangGraph)"]](#system-next-system-eg-ai-service-langgraph)
...
- [Sequence Diagrams (Key Flows)](#sequence-diagrams-key-flows)
  - [Flow: [Critical Flow Name]](#flow-critical-flow-name)
...
- [Milestones](#milestones)
  - [M1: [Milestone Name] — [Target Tag]](#m1-milestone-name-target-tag)
  - [M2: [Milestone Name] — [Target Tag]](#m2-milestone-name-target-tag)
...
- [Quality Gates](#quality-gates)
  - [Feature Iteration (v1+)](#feature-iteration-v1)
  - [Document Update Frequency](#document-update-frequency)
...
- [Decision](#decision)
  - [ADR vs RFC](#adr-vs-rfc)
- [Branch Strategy](#branch-strategy)
  - [Long-lived Branches](#long-lived-branches)
  - [Feature Branches](#feature-branches)
  - [Development Flow](#development-flow)
  - [Release Flow (dev → stable)](#release-flow-dev-stable)
...
- [Tag Versioning](#tag-versioning)
  ...
  - [Version Bumping (Conventional Commits + SemVer)](#version-bumping-conventional-commits-semver)
...
- [Coding Standards](#coding-standards)
  ...
  - [Per-project Style](#per-project-style)
  - [Naming Conventions](#naming-conventions)
- [Security Scanning](#security-scanning)
  - [Terminology](#terminology)
  - [Scanning Layers](#scanning-layers)
  - [CVSS-based Fix Priority](#cvss-based-fix-priority)
  - [CI Security Workflow](#ci-security-workflow)
  - [Claude Security Review Checklist](#claude-security-review-checklist)
- [Tech Debt Tracking](#tech-debt-tracking)
  - [How to Track](#how-to-track)
  - [Tech Debt Categories](#tech-debt-categories)
  - [Paydown Strategy](#paydown-strategy)

...
- [System Overview (16 Systems)](#system-overview-16-systems)
  - [Shared — 1 System](#shared-1-system)
  - [Whiteboard — 5 Systems](#whiteboard-5-systems)
  - [Workflow — 6 Systems](#workflow-6-systems)
  - [3D Asset — 5 Systems](#3d-asset-5-systems)
  - [System Count Summary](#system-count-summary)
- [Project Details](#project-details)
  - [1. Realtime AI Whiteboard](#1-realtime-ai-whiteboard)
  - [2. Enterprise Workflow System](#2-enterprise-workflow-system)
  - [3. 3D Asset Collaboration (Digital Twin + AIoT)](#3-3d-asset-collaboration-digital-twin-aiot)
- [Observability (Production Knowledge)](#observability-production-knowledge)
...
- [Security & Compliance](#security-compliance)
  ...
  - [SOC 2 / ISO 27001 Aligned Controls](#soc-2-iso-27001-aligned-controls)
...
- [Mobile Engineering](#mobile-engineering)
  ...
  - [OTA Updates (Over-the-Air)](#ota-updates-over-the-air)
  - [Crash Reporting](#crash-reporting)
  - [Mobile Performance Budgets](#mobile-performance-budgets)
  - [CI/CD for Mobile](#cicd-for-mobile)
- [SLA / SLO / SLI](#sla-slo-sli)
  - [Per-project SLOs](#per-project-slos)
  - [How to Monitor (Production Knowledge)](#how-to-monitor-production-knowledge)
- [API Versioning](#api-versioning)
- [API Documentation](#api-documentation)
- [Internationalization (i18n)](#internationalization-i18n)
- [Accessibility (a11y)](#accessibility-a11y)
- [Build Pipeline / Toolchain](#build-pipeline-toolchain)
  - [Why Vite](#why-vite)
...
- [Tech Diversity Overview](#tech-diversity-overview)
...
| Time-series DB | TimescaleDB               | IoT sensor data storage (3D Asset project)|
...
| IoT time-series storage        | TimescaleDB — optimized for time-bucketed queries (avg temp last 24h, anomaly detection) |

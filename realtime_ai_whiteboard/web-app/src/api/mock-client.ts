...
const mockBoards: Board[] = [
  { id: '1', title: 'Sprint Planning', templateId: 'kanban', thumbnailUrl: undefined, createdAt: '2026-04-01', updatedAt: '2026-04-01' },
  { id: '2', title: 'Product Brainstorm', createdAt: '2026-03-28', updatedAt: '2026-04-01' },
  { id: '3', title: 'Retro Q1', templateId: 'retro', createdAt: '2026-03-15', updatedAt: '2026-03-20' },
];
...
export const mockClient: ApiClient = {
  ...
  createBoard: async (title, templateId) => ({ id: String(Date.now()), title, templateId, createdAt: new Date().toISOString(), updatedAt: new Date().toISOString() }),
